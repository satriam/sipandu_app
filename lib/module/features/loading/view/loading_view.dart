...
class LoadingView extends StatefulWidget {
  ...
  Widget build(context, LoadingController controller) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Loading History"), actions: [
        IconButton(
              ...
              children: [
                ...
                Expanded(
                  child: controller.isLoading
                      ...
                      : controller.filteredLoading.isEmpty
                          ? Center(
                              child: Lottie.asset(
                                  'assets/animation/notfoundata.json'),
                            )
                          : ListView.builder(
                              itemCount: controller.filteredLoading.length,
                              physics: const ScrollPhysics(),
                              itemBuilder: (BuildContext context, int index) {
                                var item = controller.filteredLoading[index];
