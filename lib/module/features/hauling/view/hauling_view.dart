    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: controller.isLoading
            ...
            : controller.Hauling.isEmpty
                ? Center(
                    child: Lottie.asset('assets/animation/Testsat.json'),
                  )
                : ListView.builder(
                    itemCount: controller.Hauling.length,
                    physics: const ScrollPhysics(),
                    itemBuilder: (BuildContext context, int index) {
                      var item = controller.Hauling[index];
