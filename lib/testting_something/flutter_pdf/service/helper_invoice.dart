...
class HelperInvoice {
  ...
  static Future<File> generate(InvoiceModel invoice) async {
    ...
    final ByteData dataImage =
        await rootBundle.load('assets/icon/google-logo.png');
    ...
    return HelperPdfService.saveDocument(name: 'my_invoice.pdf', pdf: pdf);
  }
  ...
  static Widget buildSupplierAddress(SupplierModel supplier) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(supplier.name,
              style: TextStyle(
  ...
  static Widget buildTitle(InvoiceModel invoice, MemoryImage image) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
