...
class ImageWatermarkExtar {
  ...
  static Future<Uint8List> addTextWatermark({
    ...
    // final resizedImage = ui.copyResize(originalImage,
    ...
    ui.drawString(
      originalImage,
      font ?? ui.arial_48,
      originalImage.width - dstX,
      originalImage.height - dstY,
      watermarkText,
      color: color != null ? color.value : 0xffffffff,
